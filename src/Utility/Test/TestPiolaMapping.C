...
static const char* spline2D_basis = R"(200 1 0 0 2 0
2 2 0 0 1 1
2 2 0 0 1 1
0 0 1 0 0 1 1 1
)";
...
static const char* spline3D_basis = R"(700 1 0 0 3 0
2 2 0 0 1 1
2 2 0 0 1 1
2 2 0 0 1 1
...
TEST(TestPiolaMapping3D, Basis)
{
  ...
  ASSERT_TRUE(b.read(basis));
  ASSERT_TRUE(b.raiseOrder(1,1,1));
  ASSERT_TRUE(b.generateFEMTopology());
