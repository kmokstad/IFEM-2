...
/*!
  \brief Driver for assembly of unstructured 1D spline FE models.
  \details This class contains methods for unstructured 1D spline patches.
*/

class ASMu1D : public ASMunstruct, public ASM1D
{
public:
  //! \brief Default constructor.
  ASMu1D(unsigned char n_s = 1, unsigned char n_f = 1);
  //! \brief Copy constructor.
  ASMu1D(const ASMu1D& patch, unsigned char n_f = 0);
  ...
  virtual bool empty() const override { return curv == nullptr; }
  ...
  virtual bool write(std::ostream&, int = 0) const override;

  //! \brief Generates the finite element topology data for the patch.
  //! \details The data generated are the element-to-node connectivity array,
  //! and the global node and element numbers.
  virtual bool generateFEMTopology() override;
  ...
  virtual void clear(bool retainGeometry = false) override;
  ...
  virtual Vec3 getCoord(size_t inod) const override;
  ...
  //! in one element
  virtual bool getElementCoordinates(Matrix& X, int iel) const override;

  //! \brief Returns a matrix with all nodal coordinates within the patch.
  //! \param[out] X 3\f$\times\f$n-matrix, where \a n is the number of nodes
  //! in the patch
  virtual void getNodalCoordinates(Matrix& X) const override;

  //! \brief Updates the nodal coordinates for this patch.
  //! \param[in] displ Incremental displacements to update the coordinates with
  virtual bool updateCoords(const Vector& displ) override;
  ...
  virtual void getBoundaryNodes(int lIndex, IntVec& nodes,
                                int, int thick, int, bool local) const override;
  ...
  virtual int constrainNode(double xi, int dof, int code = 0, char basis = 1) override;
  ...
  virtual void closeEnds(int basis = 0, int master = 1) override;
  ...
  virtual bool integrate(Integrand& integrand,
			 GlobalIntegral& glbInt, const TimeDomain& time) override;
  ...
  virtual int evalPoint(const double* xi, double* param, Vec3& X) const override;
  ...
  virtual int findElementContaining(const double* param) const override;
  ...
  virtual bool tesselate(ElementBlock& grid, const int* npe) const override;
  ...
  virtual bool getSolution(Matrix& sField, const Vector& locSol,
                           const IntVec& nodes) const override;
  ...
  virtual bool evalSolution(Matrix& sField, const Vector& locSol,
                            const int* npe, int = 0) const override;
  ...
  virtual bool evalSolution(Matrix& sField, const Vector& locSol,
                            ...
                            int deriv = 0, int = 0) const override;
  ...
  virtual bool evaluate(const FunctionBase* func, RealArray& vec,
                        int basis, double time) const override;
  ...
  virtual bool evalSolution(Matrix& sField, const IntegrandBase& integrand,
                            const int* npe = nullptr, char project = 0) const override;
  ...
  //! which is assumed to be stored within the \a integrand for current patch.
  virtual bool evalSolution(Matrix& sField, const IntegrandBase& integrand,
			    const RealArray* gpar, bool = true) const override;

  //! \brief Calculates parameter values for visualization nodal points.
  //! \param[out] prm Parameter values for all points
  //! \param[in] nSegSpan Number of visualization segments over each knot-span
  virtual bool getGridParameters(RealArray& prm, int nSegSpan) const override;
...
protected:
  ...
  //! \param[in] thick Thickness of connection
  bool connectBasis(int vertex, ASMu1D& neighbor, int nvertex,
...
public:
  ...
  virtual bool getOrder(int& p1, int& p2, int& p3) const override;
  ...
  virtual bool getParameterDomain(Real2DMat& u, IntVec* corners) const override;
