...
public:
  ...
  virtual bool diracPoint(Integrand& integrand, GlobalIntegral& glInt,
                          const double* u, const Vec3& p) { return true; }
  ...
  virtual int findElementContaining(const double* param) const { return -1; }
